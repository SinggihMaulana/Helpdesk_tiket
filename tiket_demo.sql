...
(106, 'ARK-000106', 'user.demo', 'Testing', 'Dummy ticket 1', '<p>Dummy ticket 1 for demo.</p>', NULL, NULL, 0, 0, 1578140501, 0, 10, NULL, 'admin.demo;agent.demo', 'null', 0),
(107, 'ARK-000107', 'user.demo', 'Testing', 'Dummy Ticket 2', '<p>Dummy ticket 2 for feature request.</p>', 'agent.demo', '1578141285991', 0, 0, 1578141217, 50, 5, 5, 'admin.demo;agent.demo', '{\"attachments\":[{\"file_name\":\"TEST.jpg\",\"path\":\"uploads\\/04012020180329-TEST.jpg\"}]}', 1),
(108, 'ARK-000108', 'admin.demo', 'Testing', 'Dummy Ticket 3', '<p>Dummy ticket 3 for software troubleshooting.</p>', 'agent.demo', '1578141873859', 0, 0, 1578141850, 50, 10, 10, 'agent.demo', '{\"attachments\":[{\"file_name\":\"TEST.jpg\",\"path\":\"uploads\\/04012020181403-TEST.jpg\"}]}', 2),
(109, 'ARK-000109', 'agent.demo', 'Testing', 'Dummy Ticket 4', '<p>Dummy ticket for Nertwork Problem.</p>', NULL, NULL, 0, 0, 1578142453, 0, 5, NULL, 'admin.demo', '{\"attachments\":[{\"file_name\":\"TEST.jpg\",\"path\":\"uploads\\/04012020182353-TEST.jpg\"}]}', 5),
(110, 'ARK-000110', 'admin.demo', 'Testing', 'Dummy Ticket 5', '<p>Dummy ticket 5 for Hardware.</p>', 'agent.demo', '1578143391351', 0, 0, 1578143099, 100, 5, 5, 'agent.demo', '{\"attachments\":[{\"file_name\":\"TEST.jpg\",\"path\":\"uploads\\/04012020183457-TEST.jpg\"}]}', 6),
(111, 'ARK-000111', 'admin.demo', 'To test a bug that is huge', 'The last [newsletter:total] posts from our blog', '<h2>Dummy comment header</h2><p><br></p><p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p><p><br></p><p><br></p><p><strong>Following are points:</strong></p><p><strong><span class=\"ql-cursor\">?</span></strong></p><ol><li><span style=\"color: rgb(85, 85, 85);\">Point number 1</span></li><li><span style=\"color: rgb(85, 85, 85);\">Point number 2</span></li><li><span style=\"color: rgb(85, 85, 85);\">Point number 3</span>&nbsp;</li><li>Point number 4</li></ol><p><br></p><p><br></p><p>A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth. Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name of Lorem Ipsum decided to</p><p><br></p><p><br></p><p><br></p>', NULL, NULL, 0, 0, 1580456068, 0, 5, NULL, 'user.demo;agent.demo', '{\"attachments\":[{\"file_name\":\"dummy-img.jpeg\",\"path\":\"uploads\\/31012020130215-dummy-img.jpeg\"}]}', 0);
